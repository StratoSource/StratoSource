...
#    path('admin/', admin.site.urls),
    ...
    path('deployment_package/<release_package_id>', stratosource.user.views.deployment_package),
    ...
    path('release_push_package/<release_package_id>', stratosource.user.views.push_release_package),
    path('release_push_status/<release_package_push_id>', stratosource.user.views.release_push_status),
    path('releases', stratosource.user.views.releases),
    path('release/<release_id>', stratosource.user.views.release),
