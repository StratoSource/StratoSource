...
#    path('admin/', admin.site.urls),
    ...
    path('unit_testing_result/<id>', stratosource.user.unit_testing_views.result),
    ...
    path('manifest/<id>', stratosource.user.views.manifest),
    ...
    path('unreleased/<repo>/<branch>/', stratosource.user.views.unreleased),
    path('object/<id>', stratosource.user.views.object),
    path('stories', stratosource.user.views.stories),
    path('instory/<id>', stratosource.user.views.instory),
