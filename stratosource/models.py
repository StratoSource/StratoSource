...
class DeploymentPushStatus(models.Model):
    ...
    RESULT_TYPES = (('n', 'New'), ('p', 'Package Pushed'), ('e', 'Error'))
...
class ReleaseTask(models.Model):
    ...
    TASK_TYPES = ((100, 'UNSPECIFIED'), (0, 'MANIFEST'), (20, 'PRE-VALIDATION'), (40, 'PRE-RELEASE'), (60, 'RELEASE'),
                  (80, 'POST-RELEASE'))
...
class Delta(models.Model):
    ...
    def getDeltaType(self):
        if self.delta_type == 'a':
            return 'Add'
        if self.delta_type == 'd':
            return 'Delete'
        if self.delta_type == 'u':
            return 'Update'
